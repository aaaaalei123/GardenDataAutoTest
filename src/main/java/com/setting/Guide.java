...
import com.mrgd.Login;
import com.mrgd.OpenChrome;
...
// 标签参数设定
	    ...
	    Thread.sleep(1000);
	    Login.setElementValue(webDriver.findElement(By.xpath("//*[@id='app']/div/div[2]/section/div/div/div/div[4]/div/div[2]/form/div[4]/div/div/input")), "16");
	    Thread.sleep(1000);
